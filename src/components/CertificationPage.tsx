      ...
      <div className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h3 className="text-3xl md:text-4xl font-sans font-medium text-black dark:text-white mb-4">{t('자격증 발급 절차', 'Issuance Procedure')}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div className="flex items-center gap-6 mb-10">
                ...
                <h3 className="text-2xl md:text-3xl font-sans font-medium text-black dark:text-white">{t('자격증 검정료 및 발급 비용', 'Fees')}</h3>
              </div>
            ...
            >
              ...
              <div className="flex items-center gap-6 mb-10 relative z-10">
                ...
                <h3 className="text-2xl md:text-3xl font-sans font-medium">{t('입금 안내', 'Payment')}</h3>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="bg-white dark:bg-[#121212] rounded-[4rem] p-12 md:p-20 border border-black/5 dark:border-white/5 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-16">
            <div className="max-w-xl text-center lg:text-left">
              <h3 className="text-3xl md:text-4xl font-sans font-medium text-black dark:text-white mb-6">{t('발급 관련 문의사항이 있으신가요?', 'Have questions?')}</h3>
