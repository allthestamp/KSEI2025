...
const FaqPage: React.FC<Props> = ({ t }) => {
  ...
  return (
    <div className="pt-32 pb-24 bg-white dark:bg-[#0a0a0a] min-h-screen transition-colors duration-500">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        ...
        <div className="text-left md:text-center mb-16">
          ...
          >
            <h2 className="text-[11px] font-bold tracking-[0.4em] uppercase text-emerald-600 mb-6 flex items-center justify-start md:justify-center gap-4">
              <span className="w-12 h-[1px] bg-emerald-600"></span>
              FAQ
              <span className="hidden md:block w-12 h-[1px] bg-emerald-600"></span>
            </h2>
            ...
            <p className="text-left md:text-center text-gray-500 dark:text-gray-400 max-w-2xl mx-0 md:mx-auto">
                  ...
                  >
                    <div className="flex justify-between items-center gap-4">
                      <div className="flex items-start gap-4">
                        ...
                        <span className="font-bold text-black dark:text-white leading-tight">{faq.question}</span>
                      </div>
      ...
      <div id="visit-us" className="py-24 bg-white dark:bg-[#0a0a0a] border-t border-black/5 dark:border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Address Card */}
            <div className="bg-gray-50 dark:bg-white/5 p-10 rounded-[2.5rem] border border-black/5 dark:border-white/5 text-center group hover:border-emerald-500/30 transition-all duration-500">
              <div className="w-16 h-16 bg-emerald-500 text-white rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/20 mx-auto mb-8 group-hover:scale-110 transition-transform">
            ...
            {/* Phone Card */}
            <div className="bg-gray-50 dark:bg-white/5 p-10 rounded-[2.5rem] border border-black/5 dark:border-white/5 text-center group hover:border-blue-500/30 transition-all duration-500">
              <div className="w-16 h-16 bg-blue-500 text-white rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/20 mx-auto mb-8 group-hover:scale-110 transition-transform">
              ...
              <p className="text-sm text-gray-400 dark:text-gray-500">{t('평일 10:00 - 18:00 (주말 휴무)', 'Weekdays 10:00 - 18:00 (Closed on weekends)')}</p>
            </div>

            {/* Email Card */}
            <div className="bg-gray-50 dark:bg-white/5 p-10 rounded-[2.5rem] border border-black/5 dark:border-white/5 text-center group hover:border-emerald-500/30 transition-all duration-500">
              <div className="w-16 h-16 bg-black dark:bg-white text-white dark:text-black rounded-2xl flex items-center justify-center shadow-lg mx-auto mb-8 group-hover:scale-110 transition-transform">
