...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "아니요. 스탬프 제품은 별도로 지정되어 있지 않으며, 포트폴리오 스탬프 기준에 맞춰 자유롭게 선택하여 사용하실 수 있습니다.\n제품 선택에 어려움이 있으신 경우, 협업 업체에서 판매 중인 스탬프 키트를 참고해 주시기 바랍니다.\n관련 제품은 아래 링크에서 확인하실 수 있습니다.\nhttps://mkt.shopping.naver.com/link/69d31b60c81d717af867bbc3",
    answerEn: "No, there is no designated stamp product required for the certification exam. You may freely select a product that meets the portfolio stamp requirements.\nIf you are unsure which product to choose, you may refer to the stamp kit provided by our partner company.\nPlease see the link below for more details:\nhttps://mkt.shopping.naver.com/link/69d31b60c81d717af867bbc3"
  },
  {
    category: "결제/환불",
  ...
  },
  {
    ...
    answer: "필기 시험은 당일 확인이 가능하며, 실기 시험의 경우 채점 과정을 거쳐 응시일로부터 14일 이내에 개별 연락을 통해 발표됩니다.",
    answerEn: "Written exam results can be checked on the same day. Practical exam results are announced within 14 days from the test date through individual contact after the grading process."
  },
  {
    category: "시험/접수",
                        ...
                        >
                          <div className="pt-6 mt-6 border-t border-black/5 dark:border-white/5">
                            <div className="flex items-start gap-4 md:gap-6">
                              ...
                              <div className="text-gray-600 dark:text-gray-400 leading-relaxed text-base md:text-lg font-light whitespace-pre-line">
                                {t(faq.answer, faq.answerEn).split(/(https?:\/\/[^\s]+)/g).map((part, i) => 
                                  part.match(/^https?:\/\//) ? (
                                    <a key={i} href={part} target="_blank" rel="noopener noreferrer" className="text-emerald-600 dark:text-emerald-400 hover:underline break-all">
                                      {part}
                                    </a>
                                  ) : (
                                    part
